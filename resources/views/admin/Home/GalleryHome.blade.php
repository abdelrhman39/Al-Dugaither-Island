        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">{{ __('admin.HomePage/Gallery') }}</h3>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-info text-white">
                            <a data-action="collapse" class="card-title">{{ __('admin.Add Gallerys Home Page') }}</a>
                            ...
                            <div class="card-body">
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('admin.AddGalleryHome') }}" method="POST"
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{ __('admin.HomePage/Gallery') }} </h4>
                                    <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                                    <div class="heading-elements">
                                        <ul class="list-inline mb-0">
                                                            ...
                                                            @isset($GalleryHome)
                                                                @foreach ($GalleryHome as $img)
                                                                    <figure class="col-lg-3 col-md-6 col-12  position-relative" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                                                        <a  href="{{ asset('uploads/GalleryHome/'.$img->image)}}" itemprop="contentUrl" data-size="480x360">
                                                                        <img class="img-thumbnail img-fluid" src="{{ asset('uploads/GalleryHome/'.$img->image)}}"
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form action="{{ route('admin.Delete_AddGalleryHome',$img->id) }}"
                                                                                    method="POST">
                                                                                    @csrf
